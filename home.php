            ...
            <div class="col-12" id="basicSearchResult">
                <div class="row">
                    ...
                    ?>
                        ...
                        `category_id` = '". $category_data2["id"]."' AND `status_status_id` ='1' ORDER BY 
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                            <div class="border border-primary mt-2 mb-2">
                                            ...
                                            <div class="card-body ms-0 m-0 text-center">
                                                ...
                                                if($product_data["qty"] > 0){
                                                    ?>
                                                        ...
                                                        <span class="card-text text-success fw-bold"><?php echo $product_data["qty"]; ?></span><br /><br />
                        ...
                        <div class="col-12 text-center border border-1 border-danger ">
                            <p class="h3 fw-bold text-danger mt-3 mb-3">No Item To Preview Yet 🤪</p>
                        </div>
                        <?php
                    }
                        ?>
