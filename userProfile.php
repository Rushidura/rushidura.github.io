    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["u"])){
                ...
                users.gender_gender_id=gender_id WHERE `email` ='".$email."'");
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-3 border-end">
                                ...
                                ?>
                                    ...
                                    <span class="fw-bold"><?php echo $details_data["fname"]; ?> <?php echo $details_data["lname"]; ?></span>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" readonly
                                                value="<?php echo $details_data["joined_date"] ?>" />
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" onchange="selectdistrict();" id="district">
